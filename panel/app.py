...
# --- Configuration & Setup ---
CONFIG_PATH = "../config.yaml" # Relative path from panel/ to root
DB_DIR = "../database" # Relative path from panel/ to root
...
def verify_login(username, password):
    ...
    try:
        ...
        st.error("Configuration file missing. Cannot verify login.")
        return False
    except Exception as e:
